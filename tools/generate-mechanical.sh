...
printf '%s\n' "$generator_output"
if ! grep -Fq "Generated EDGE-18 Rev. A FreeCAD and STEP artifacts" \
...
for artifact in \
    "$project_root/mechanical/native/edge18-rev-a-assembly.FCStd" \
    "$project_root/mechanical/step/edge18-rev-a-enclosure-base.step" \
    "$project_root/mechanical/step/edge18-rev-a-enclosure-lid.step" \
    "$project_root/mechanical/step/edge18-rev-a-assembly.step"; do
